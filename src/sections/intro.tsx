	...
	return (
		<>
				...
				<div className="flex items-center">
					<div className="leading-[1] w-full text-center">
						...
						<div className="absolute z-40 left-1/2 -ml-[25px] bottom-14 animate-bounce">
							<Link to={'about'} smooth={true} spy={true} offset={-20} className="hover:cursor-pointer flex">
			...
			<div className="absolute h-full w-full z-20">
				<Image src="/static/img/bg_intro.png" blurDataURL="/static/img/bg_intro.png" placeholder="blur" priority={true}
